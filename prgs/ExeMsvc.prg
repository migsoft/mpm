...
*-----------------------------------------------------
   ...
   Out := Out + 'INCLUDE_DIR = '   + cHarbourFolder + '\INCLUDE /i' +INCFOLDER+' /i'+ cMiniGuiFolder + '\INCLUDE /i' + cProjFolder +' /i' + AddQuote( cVisualFolder + '\INCLUDE' ) + NewLi
   Out := Out + 'CC_LIB_DIR = '    + AddQuote( cVisualFolder + '\LIB' )  + NewLi
   Out := Out + 'INCLUDE_C_DIR = ' + AddQuote( cVisualFolder + '\INCLUDE')+' /I' + cHarbourFolder + '\INCLUDE /I' + cMiniGuiFolder + '\INCLUDE /I' + cProjFolder + NewLi
