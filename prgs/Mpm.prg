...
*---------------------------------------------------------------------*
Procedure OpenMPM2( ProjectFile ) // VersiÛn antig¸a de .mpm
*---------------------------------------------------------------------*
...
*---------------------------------------------------------------------*
    ...
    // nModo    = RadioGroup_7 - Exe - Librer√≠a
...
*---------------------------------------------------------------*
   ...
   axHba:= {'libhbsix.a', cMT_xHba  , 'librdd.a' , 'libmacro.a' , 'libpp.a' , 'librtl.a' , 'liblang.a', 'libcommon.a', 'libnulsys.a', 'libdbfntx.a', 'libdbfcdx.a', 'libdbffpt.a', 'libct.a', 'liblibmisc.a', 'libhbodbc.a', 'libodbc32.a', 'libuse_dll.a', 'libpcrepos.a', 'libcodepage.a', 'libzlib.a', 'libtip.a', 'librdds.a','libdll.a','libsocket.a' }
   axHba1:={'lhbsix'    , cMT_xHba1 , 'lrdd'     , 'lmacro'     , 'lpp'     , 'lrtl'     , 'llang'    , 'lcommon'    , 'lnulsys'    , 'ldbfntx'    , 'ldbfcdx'    , 'ldbffpt'    , 'lct'    , 'llibmisc'    , 'lhbodbc'    , 'lodbc32'    , 'luse_dll'    , 'lpcrepos'    , 'lcodepage'    , 'lzlib'    , 'ltip'    , 'lrdds'    ,'ldll'    ,'lsocket' }
